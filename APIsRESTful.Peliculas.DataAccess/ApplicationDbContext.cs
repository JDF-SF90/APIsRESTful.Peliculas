    ...
    public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
    {
        public ApplicationDbContext CreateDbContext(string[] args)
        {
            ...
            IConfigurationRoot _configuration = new ConfigurationBuilder()
                    .SetBasePath(@"D:\udemy\construyendo-web-apis-restful-con-aspnet-core\Peliculas\APIsRESTful.Peliculas\APIsRESTful.Peliculas.WebApi")
            ...
            var connectionString = _configuration.GetConnectionString("PeliculasConnection");
